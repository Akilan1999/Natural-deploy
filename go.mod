...
require (
	github.com/Akilan1999/p2p-rendering-computation v0.0.0-20260805134124-98d20531747b
...
require (
	...
	github.com/ihciah/rust2go v0.0.0-20251105132719-caedb7aac7b2 // indirect
